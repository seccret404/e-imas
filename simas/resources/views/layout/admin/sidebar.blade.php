          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu show" data-bs-popper="static">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <div class="dropend">
                    <a class="dropdown-item dropdown-toggle show" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true">
                      Jurusan
                      <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">IPA</span>
                    </a>
                    <div class="dropdown-menu show" data-bs-popper="static">
                ...
                <div class="dropdown-menu-columns">
                  <div class="dropdown-menu-column">
                    <div class="dropend">
                      <a class="dropdown-item dropdown-toggle show" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true">
                        Jurusan
                        <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">IPS</span>
                      </a>
                      <div class="dropdown-menu show" data-bs-popper="static">
                        <a href="./cards.html" class="dropdown-item">
                          10
