<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand navbar-brand-autodark">
        <a href=".">
          <img src="{{asset('tabler/static/e-simasfix.webp')}}" style="width:150px; height:100px;border-radius:20px" alt="Tabler" class="navbar-brand-image">
        </a>
      </h1>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/tahun-akademik" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="/prestasi-admin" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-door" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M14 12v.01"></path>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                    <a href="/ipa-kelas-10" class="dropdown-item">
                        10
                      </a>
                      <a href="/ipa-kelas-11" class="dropdown-item">
                        11
                      </a>
                      <a href="/ipa-kelas-12" class="dropdown-item">
                        12
                      </a>
                </div>
              </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                    <a href="/ips-kelas-10" class="dropdown-item">
                        10
                      </a>
                      <a href="/ips-kelas-11" class="dropdown-item">
                        11
                      </a>
                      <a href="/ips-kelas-12" class="dropdown-item">
                        12
                      </a>
                </div>
              </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item" href="/siswa-terdaftar">
                   Siswa Terdaftar
                  </a>
                  <a class="dropdown-item" href="/pmb.siswabaru/register">
                    Form
                  </a>
                </div>
              </div>
