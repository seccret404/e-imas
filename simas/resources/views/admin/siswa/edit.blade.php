                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="/siswa"><button type="button" class="btn-close" data-bs-dismiss="modal"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $siswa->nama }}" id="nama_dept" name="nama"
                                                class="form-control" placeholder="Nama siswa">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-label">Foto Siswa Sebelumnya</div>
                                    <img src="{{ url('asset/profil/' . $siswa->profil) }}" alt="{{ $siswa->profil }}"
                                        class="mb-2">
