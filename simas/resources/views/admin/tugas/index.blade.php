                                ...
                                <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->jurusan}}</td>
                                            <td>{{$item->kelas}}</td>
                                            <td><a href="{{  url('asset/tugas/'.$item->file) }}" alt="{{ $item->file }}">Lihat File</a></td>
                                            <td>

                                                 <form method="POST" action="/tugas/{{$item->id_tugas}}/delete" class="mt-2">
                                                    @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/tugas-add"  enctype="multipart/form-data" method="POST" id="form_departemen">
                    @csrf
                    <div class="row mt-3">
                        <div class="col-12">
