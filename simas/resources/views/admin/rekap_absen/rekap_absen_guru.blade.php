        ...
        <div class="container-xl">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('rekapabsenguru') }}" method="GET">
                                                    ...
                                                    <td>
                                                        @if ($attendance)
                                                            @if ($attendance->jam_masuk !== null && $attendance->jam_keluar !== null)
                                                                K
                                                            @elseif ($attendance->jam_keluar == null && $attendance->jam_masuk >= '08:00:00')
                                                                MT
                                    ...
                                    <div class="col-12">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama</th>
                                                <th colspan="{{ count($datesInMonth) }}">Presensi Bulan {{ date('F Y') }}
                                                </th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                        ...
                                        <tbody>
                                            @foreach ($absen as $item)
                                                <tr>
                                                    ...
                                                    @foreach ($datesInMonth as $date)
                                                        <td>
                                                            @if (date('Y-m-d', strtotime($item->tgl_presensi)) === $date)
                                                                sudah absen
                                                            @else
                                                                -
                                                            @endif
