                            ...
                            <div class="form-gorup">
                                <div class="form-label">Kode Guru</div>
                                 ...
                                 <select name="kode_guru" id="kode_dept" class="form-select tomselected ">
                                    <option value="">Guru pembina</option>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jurusan" value="IPS" checked="">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kelas" value="12" checked="" >
