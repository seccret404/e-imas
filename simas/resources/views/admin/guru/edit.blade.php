                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="/guru"> <button type="button" class="btn-close" data-bs-dismiss="modal"
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/guru/edit/' . $guru->id) }}" method="POST" id="form_departemen"
                                ...
                                <div class="mb-3">
                                    <div class="form-label">Foto Guru Sebelumnya</div>
                                    <img src="{{ url('asset/guru/' . $guru->profil) }}"
                                            alt="{{ $guru->profil }}" class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $guru->kode_guru }}" id="nama_dept"
                                                name="kode_guru" class="form-control" placeholder="inisial">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $guru->alamat }}" id="nama_dept"
