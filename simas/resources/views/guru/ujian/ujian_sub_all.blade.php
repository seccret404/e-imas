                            ...
                            <div class="row mt-4">
                                <table class="table table-bordered">
                                    <div class="col-12">
                                        ...
                                        <tbody>
                                            @foreach ($ujianall as $item)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>{{ $item->nama_pengumpul }}</td>
                                                    <td><a href="{{ url('asset/hasil/' . $item->file_hasil_ujian) }}"
                                                            target="_blank"
                                                            alt="{{ $item->file_hasil_ujian }}">{{ $item->file_hasil_ujian }}
                                                            {{-- <img
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <div class="col">
                                                                <a href="/ujiangurunilai/edit/{{ $item->id }}" class="text-primary"><strong>
                                                                        <p>Beri Nilai</p>
                                                                    </strong></a>
                                                            </div>
                                                        @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ '/ujiangurunilai/edit/' . $ujian->id }}" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="nama_dept" name="nama" class="form-control"
                                            value="{{ $ujian->nama_pengumpul }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <a href="{{ url('asset/hasil/' . $item->file_hasil_ujian) }}" target="_blank">
                                <img src="{{ url('asset/hasil/' . $item->file_hasil_ujian) }}"
                                    alt="{{ $item->file_hasil_ujian }}">
                            </a>
                        </div>
                        <div class="row">
                            <div class="col-12">
