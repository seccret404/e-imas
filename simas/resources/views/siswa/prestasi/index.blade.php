                                        ...
                                        <tbody>
                                            @foreach ($prestasi as $item)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('asset/prestasi/' . $item->file) }}"
                                                            alt="{{ $item->file }}">Lihat File</a></td>
                                                    <td>{{ $item->catatan }}</td>
                                                    <td>{{ $item->created_at }}</td>
                                                    <td>
                                                        <a href="/prestasi/edit/{{ $item->id }}"
                                                        ...
                                                        <form method="POST" action="/prestasi/{{ $item->id }}/delete"
                                                            class="mt-2">
                                                            @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/prestasi-add" enctype="multipart/form-data" method="POST" id="form_departemen">
                        @csrf
                        <div class="row">
                            <div class="col-12"> <label class="form-label required">Nama Prestasi</label>
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_prestasi" name="nama_prestasi"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="file" value="" id="file_prestasi" name="file" required
                                        class="form-control" placeholder="Nama Prestasi">
                                </div>
                            </div>
                        </div>
