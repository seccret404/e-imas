    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('tabler/static/e-simasfix.webp') }}"
                    style="width:150px; height:100px;border-radius:20px" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ \Request::is('tahun-akademik') ? 'active' : '' }}" href="/tahun-akademik">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" {{ \Request::is('guru', 'keahlian', 'siswa') ? 'active' : '' }}
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ \Request::is('guru') ? 'active' : '' }}" href="/guru">
                                    Data Guru
                                </a>
                                <a class="dropdown-item {{ \Request::is('keahlian-admin') ? 'active' : '' }}"
                                    href="/keahlian-admin">
                                    Keahlian Guru
                                </a>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ \Request::is('prestasi-admin') ? 'active' : '' }}" href="/prestasi-admin">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-door"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ \Request::is('ipa-kelas-10', 'ipa-kelas-11', 'ipa-kelas-12') ? 'active' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a href="/ipa-kelas-10"
                                    class="dropdown-item {{ \Request::is('ipa-kelas-10') ? 'active' : '' }}">
                                    10
                                </a>
                                <a href="/ipa-kelas-11"
                                    class="dropdown-item {{ \Request::is('ipa-kelas-11') ? 'active' : '' }}">
                                    11
                                </a>
                                <a href="/ipa-kelas-12"
                                    class="dropdown-item {{ \Request::is('ipa-kelas-12') ? 'active' : '' }}">
                                    12
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ \Request::is('ips-kelas-10', 'ips-kelas-11', 'ips-kelas-12') ? 'active' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a href="/ips-kelas-10"
                                    class="dropdown-item {{ \Request::is('ips-kelas-10') ? 'active' : '' }}">
                                    10
                                </a>
                                <a href="/ips-kelas-11"
                                    class="dropdown-item {{ \Request::is('ips-kelas-11') ? 'active' : '' }}">
                                    11
                                </a>
                                <a href="/ips-kelas-12"
                                    class="dropdown-item {{ \Request::is('ips-kelas-12') ? 'active' : '' }}">
                                    12
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ \Request::is('siswa-terdaftar', 'pmb.siswabaru/register') ? 'active' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ \Request::is('siswa-terdaftar') ? 'active' : '' }}"
                                    href="/siswa-terdaftar">
                                    Siswa Terdaftar
                                </a>
                                <a class="dropdown-item {{ \Request::is('pmb.siswabaru/register') ? 'active' : '' }}"
                                    href="/pmb.siswabaru/register">
                                    Form
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ \Request::is('guru-email', 'siswa-email', 'wali-email', 'email-all') ? 'active' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ \Request::is('guru-email') ? 'active' : '' }}"
                                    href="/guru-email">
                                    Kirim Pesan Ke Guru
                                </a>
                                <a class="dropdown-item {{ \Request::is('siswa-email') ? 'active' : '' }}"
                                    href="/siswa-email">
                                    Kirim Pesan Ke Siswa
                                </a>
                                <a class="dropdown-item {{ \Request::is('wali-email') ? 'active' : '' }}"
                                    href="/wali-email">
                                    Kirim Pesan Ke Wali
                                </a>
                                <a class="dropdown-item {{ \Request::is('email-all') ? 'active' : '' }}"
                                    href="/email-all">
                                    Kirim Kesemua
                                </a>
                            </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ \Request::is('guru-surat') ? 'active' : '' }}"
                                    href="/guru-surat">
