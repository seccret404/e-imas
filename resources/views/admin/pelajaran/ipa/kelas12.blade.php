                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="nama_pelajaran" id="nama_pelajaran" class="form-select tomselected">
                                        ...
                                        @foreach ($mapel as $item)
                                            <option
                                                ...
                                                data-kode-guru="{{ $item->kode_guru }}">{{ $item->nama_pelajaran }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="time" value="" id="nama_dept" name="jam_masuk"
...
@push('myscript')
            ...
            $("#form_departemen").submit(function() {
                ...
                if (kode_dept == "") {
                    Swal.fire({
                        position: 'top-center',
                        icon: 'warning',
                        title: 'Data pelajaran tidak boleh kosong!',
    ...
    <script>
        $(document).ready(function() {
            $('#nama_pelajaran').change(function() {
                var kodeGuru = $(this).find(':selected').data('kode-guru');
                $('#kode_guru').val(kodeGuru);
            });
        });
    </script>
@endpush
